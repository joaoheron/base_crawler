...
class Action():
    ...
    def __init__(self, action_type=None, action_target=None, action_selector_kind=None, wait_for=None, wait_for_kind=None, keys=None, timeout=30):
        # action_type='click', action_target='id_do_elemento', action_selector_kind='id', wait_for='elemento_a_esperar', wait_for_kind='id', keys='abcdef', timeout=30)
